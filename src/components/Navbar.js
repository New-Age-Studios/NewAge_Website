          ...
          <div className="flex flex-col gap-2 mt-4 pt-4 border-t border-white/10">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-[15px] text-white font-medium">{dict.cart || "Cart"}</span>
              </div>
              {packagesCount > 0 && (
            ...
            {username ? (
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-white/5">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center bg-orange-500 text-white font-bold text-sm">
                    {username.charAt(0).toUpperCase()}
                  </div>
                ...
                <button 
                  ...
                  className="flex items-center gap-3 px-5 py-3 rounded-2xl hover:bg-white/5 transition-all text-left text-white/80"
                >
                  <History size={18} />
                  <span className="text-[14px] font-medium">Manage Orders</span>
                </button>
                ...
                {authMethods.some(m => m.name === "Discord") && (
                  ...
                  >
                    ...
                    <span className="text-[14px] font-medium">Connect Discord</span>
                  </button>
                )}
                ...
                <button 
                  ...
                  className="flex items-center gap-3 px-5 py-3 rounded-2xl hover:bg-white/5 transition-all text-left text-red-400"
                >
                  <LogOut size={18} />
              ...
              <button
                ...
                disabled={isPending}
                className="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl text-[15px] font-bold text-white transition-all active:scale-95 shadow-lg"
              ...
              >
                {isPending ? (
                  ...
                  <img src="/tebexsmall.svg" alt="Tebex" className="h-5 w-auto object-contain brightness-0 invert" />
                )}
                {isPending ? "Connecting..." : "Login with FiveM"}
              </button>
            )}
            ...
            <div className="flex gap-2 mt-2">
              <button 
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-bold transition-all ${lang === 'en' ? 'bg-orange-500/20 text-orange-500 border border-orange-500/30' : 'bg-white/5 text-white/50 hover:bg-white/10 hover:text-white'}`}
              >
                <Globe size={16} /> EN
              </button>
              <button 
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-bold transition-all ${lang === 'pt-br' ? 'bg-orange-500/20 text-orange-500 border border-orange-500/30' : 'bg-white/5 text-white/50 hover:bg-white/10 hover:text-white'}`}
              >
                <Globe size={16} /> PT-BR
              </button>
            </div>
